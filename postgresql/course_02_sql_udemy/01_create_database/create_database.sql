...
-- DONE
-- OBS: the psql works with this data format: MONTH/DAY/YEAR
...
-- see the error about data format
-- this error will be solved in the next class
...
-- LINE 1: ...sarmstrong1@infoseek.co.jp','Masculino','Esporte','3/31/2008...
--                                                              ^
